# from app.infrastructure.scraping.playwright_client import scrape_url
# from app.domain.tools.text_cleaner import clean_text, chunk_text
# from app.domain.llm_providers.hf_embedding_provider import get_embedding
from app.infrastructure.vectorstores.pinecone_store import (
    # upsert_embeddings,
    query_embeddings,
)
